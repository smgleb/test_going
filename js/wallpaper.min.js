...
let resultFinalBlock = (res) => {
	...
	let resultFinalWallapersStepWindow = (Math.ceil(perimetrTwo / resultWidthNum) + numDoorAndWindow) / Math.round(resultLengthNum / (heightAllItem - resultHeightWindow));
	let resultFinalWallapersStepDoor = (Math.ceil(perimetrThree / resultWidthNum) + numDoorAndWindow) / Math.round(resultLengthNum / (heightAllItem - resultHeightDoor));
