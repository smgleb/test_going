...
wallpaperForm.addEventListener('submit', (e) => {
	...
	if (roomBlock.classList.contains('_active')) {
		if (resArr !== false) {
			resultFinalBlock(1);
			if (!resultFinalWallapers || !isFinite(resultFinalWallapers)) {
				resultFinalWallapers = '<br><span style="font-size:18px">Введите данные корректно</span>';
				squareRoom = '<br><span style="font-size:18px">Введите данные корректно</span>';
				squareWallpapers = '<br><span style="font-size:18px">Введите данные корректно</span>';
			}
